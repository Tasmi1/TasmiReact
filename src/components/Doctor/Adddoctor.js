...
class Adddoctor extends React.Component{
      ...
      submitForm = (e) => {
          ...
          axios.post('http://localhost:3000/Doctor', this.state)
              .then((response) => {
                   ...
                   <Col>
                    ...
                    <FormGroup>
                        ...
                        <Input type='text' name='specialist' id='specialist'
                            value={this.state.specialist} onChange={this.handleChange} />
                    </FormGroup>
                    </Col>
                     


                      <Button color="primary" onClick={this.submitForm} type="submit" href="/dashboard" >ADD Doctor</Button>
