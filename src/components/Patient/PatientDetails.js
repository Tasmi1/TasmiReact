...
export class PatientDetails extends Component{
    ...
    UpdatePatientDetails(event){
        ...
        var object={"PatientName":this.patientDetailsUpdate.PatientName,"PatientAddress":this.patientDetailsUpdate.PatientAddress,"PatientAge":this.patientDetailsUpdate.PatientAge,"PatientProblem":this.patientDetailsUpdate.PatientProblem,"PatientPrescription":this.patientDetailsUpdate.PatientPrescription}
